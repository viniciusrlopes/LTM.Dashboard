<%@ Page Title="View Message" Language="C#" MasterPageFile="~/Mail.Master" AutoEventWireup="true" CodeBehind="ViewMessage.aspx.cs" Inherits="BeyondAdmin.WebForms.Pages.ViewMessage" %>

<asp:Content ID="Main" ContentPlaceHolderID="MainContent" runat="server">
    <div class="mail-container">
        <div class="mail-header">
            <div class="mail-title">
                <strong>Your Bing Newsletter: The May Issue</strong>
        ...
        <div class="mail-body">
            <div class="mail-info">
                <div class="mail-sender">
                    <a href="#">
                        <img src="/assets/img/avatars/divyia.jpg" class="img-circle" width="30" />
                        <span>Divyia Phillips</span>
                ...
                <ul>
                    ...
                    <li>
                        <a href="#" class="thumb download">
                            <img src="/assets/img/attach-yellow.png" />
                        </a>

                        <a href="#" class="name">attach-yellow.png
                                            <span>14KB</span>
                        </a>
                    ...
                    <li>
                        <a href="#" class="thumb">
                            <img src="/assets/img/attach-green.png" />
                        </a>

                        <a href="#" class="name">attach-green.png
                                            <span>14KB</span>
                        </a>
                    ...
                    <li>
                        <a href="#" class="thumb download">
                            <img src="/assets/img/attach-red.png" />
                        </a>

                        <a href="#" class="name">attach-red.png
                                            <span>11KB</span>
                        </a>
            ...
            <div class="mail-reply">
                ...
                <div class="reply-form">
                    <div>
                        <a href="/Pages/Compose.aspx">Reply</a> or <a href="/Pages/ViewMessage.aspx">Forward</a> this message...
                    </div>
                </div>
