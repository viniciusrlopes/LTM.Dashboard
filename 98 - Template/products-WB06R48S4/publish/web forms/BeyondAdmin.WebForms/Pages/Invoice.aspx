<%@ Page Title="Invoice" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="BeyondAdmin.WebForms.Pages.Invoice" %>
            ...
            <div class="well invoice-container">
                ...
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>
                                <h5 class="no-margin-bottom">Service</h5>
                            </th>
                            <th>
                                <h5 class="no-margin-bottom">Description</h5>
                            </th>
                            <th>
                                <h5 class="no-margin-bottom text-center">Hrs/Qty</h5>
                            </th>
                            <th>
                                <h5 class="no-margin-bottom text-center">Rate/Price</h5>
                            </th>
                            <th>
                                <h5 class="no-margin-bottom text-center">Sub Total</h5>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
