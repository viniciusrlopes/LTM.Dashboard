<%@ Page Title="Widgets" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Widgets.aspx.cs" Inherits="BeyondAdmin.WebForms.Pages.Widgets" %>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            <code>class="widget-header bg-palegreen"
                            </code>
                ...
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="widget">
                        ...
                        <!--Widget Header-->
                        <div class="widget-body">
                            <code>class="widget-header bg-lightred"
                            </code>
                        </div>
                        <!--Widget Body-->
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="widget">
                        ...
                        <!--Widget Header-->
                        <div class="widget-body">
                            <code>class="widget-header bg-blue"
                            </code>
                        </div>
                        <!--Widget Body-->
                    </div>
                ...
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="widget">
                        ...
                        <!--Widget Header-->
                        <div class="widget-body">
                            <code>class="widget-header bg-blueberry"
                            </code>
                        </div>
                        <!--Widget Body-->
                    </div>
                            ...
                            <div class="widget-buttons">
                                <div class="progress progress-striped" style="width: 150px;">
                                    <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 60%">
                                        <span class="sr-only">20% Complete (success)
                                        </span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="widget">
                        <div class="widget-header">
                            ...
                            <div class="widget-buttons">
                                <span class="badge badge-info graded">7
                                </span>
                            </div>
                            <div class="widget-buttons buttons-bordered">
