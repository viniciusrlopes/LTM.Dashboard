<%@ Page Title="داشبورد" Language="C#" MasterPageFile="~/Arabic.Master" AutoEventWireup="true" CodeBehind="Arabic.aspx.cs" Inherits="BeyondAdmin.WebForms.Pages.Arabic" %>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="databox radius-bordered bg-white">
                        ...
                        <div class="databox-left">
                            ...
                            <div class="databox-text darkgray">المهام الجديدة</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="databox radius-bordered bg-white">
                        ...
                        <div class="databox-left">
                            ...
                            <div class="databox-text darkgray">رسالة جديدة</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="databox radius-bordered bg-white">
                        ...
                        <div class="databox-left">
                            ...
                            <div class="databox-text darkgray">مشترکین جديدة</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="databox radius-bordered bg-white">
                        ...
                        <div class="databox-left padding-top-20">
                            ...
                            <div class="databox-text darkgray">جان اسمیت</div>
                            <div class="databox-text darkgray">موزع نمونه</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-12">
                    <div class="dashboard-box">
                        ...
                        <div class="box-progress">
                            <div class="progress-handle">یوم 20</div>
                        ...
                        <div class="box-tabbs">
                            <div class="tabbable">
                                <ul class="nav nav-tabs tabs-flat  nav-justified" id="myTab11">
                                    <li class="active">
                                        <a data-toggle="tab" href="#realtime">في الوقت الحقيقي
                                        </a>
                                    </li>
                                    <li>
                                        <a data-toggle="tab" href="#visits">مرة
                                        </a>
                                    </li>
                                    <li>
                                        <a data-toggle="tab" id="contacttab" href="#bandwidth">عرض النطاق الترددي
                                        </a>
                                    </li>
                                    <li>
                                        <a data-toggle="tab" href="#sales">مبيعات
                                        </a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                <div class="databox databox-xlg databox-vertical databox-inverted databox-shadowed">
                                                    ...
                                                    <div class="databox-bottom no-padding text-align-center">
                                                        ...
                                                        <span class="databox-text lightcarbon no-margin">وحدة بيع / ساعة</span>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                <div class="databox databox-xlg databox-vertical databox-inverted databox-shadowed">
                                                    ...
                                                    <div class="databox-bottom no-padding text-align-center">
                                                        ...
                                                        <span class="databox-text lightcarbon no-margin">الدخل / ساعة</span>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                <div class="databox databox-xlg databox-vertical databox-inverted databox-shadowed">
                                                    ...
                                                    <div class="databox-bottom no-padding text-align-center">
                                                        ...
                                                        <span class="databox-text lightcarbon no-margin">الطلبيات الجديدة</span>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                <div class="databox databox-xlg databox-vertical databox-inverted  databox-shadowed">
                                                    ...
                                                    <div class="databox-bottom no-padding text-align-center">
                                                        ...
                                                        <span class="databox-text lightcarbon no-margin">تذاکر الجديدة</span>
                                ...
                                <div class="col-lg-4 col-sm-4 col-xs-12">
                                    <div class="notification">
                                        <div class="clearfix">
                                            ...
                                            <div class="notification-body">
                                                <span class="title">شنقاً مع الأطفال</span>
                                ...
                                <div class="col-lg-4 col-sm-4 col-xs-12">
                                    <div class="notification">
                                        <div class="clearfix">
                                            ...
                                            <div class="notification-body">
                                                <span class="title">اجتماع مع بتی</span>
                                                <span class="description">01:00 pm</span>
                                            </div>
                                            <div class="notification-extra">
                                                <i class="fa fa-clock-o orange"></i>
                                                <span class="description">فی الدیوان</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="orders-container">
                ...
                <ul class="orders-list">
                    <li class="order-item">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 item-right">
                                <div class="item-booker">نید استاردز</div>
                                <div class="item-time">
                                    <i class="fa fa-calendar"></i>
                                    <span>منذ 10 دقيقة</span>
                                </div>
                            </div>
                    ...
                    <li class="order-item top">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 item-right">
                                <div class="item-booker">ستيف لويس</div>
                                <div class="item-time">
                                    <i class="fa fa-calendar"></i>
                    ...
                    <li class="order-item">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 item-right">
                                <div class="item-booker">جون فورد</div>
                                <div class="item-time">
                                    <i class="fa fa-calendar"></i>
                                    <span>اليوم 8 يوليو</span>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 item-left">
                                <div class="item-price">
                    ...
                    <li class="order-item">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 item-right">
                                <div class="item-booker">كيم باسنجر</div>
                                <div class="item-time">
                                    <i class="fa fa-calendar"></i>
                                    <span>يوم أمس 7 يوليو</span>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 item-left">
                                <div class="item-price">
                ...
                <div class="orders-footer">
                    <a class="show-all" href=""><i class="fa fa-angle-down"></i>تظهر جميع</a>
                    <div class="help">
        ...
        <div class="col-lg-4 col-sm-12 col-xs-12">
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-themeprimary">
                    ...
                    <span class="widget-caption themeprimary">مجلس المهمة</span>
                </div>
                <!--Widget Header-->
                        ...
                        <ul class="tasks-list">
                            <li class="task-item">
                                ...
                                <div class="task-state">
                                    <span class="label label-yellow">في التقدم
                                    </span>
                                </div>
                                <div class="task-time">1 منذ ساعة</div>
                                <div class="task-body">نسأل لسيسادمينس لتثبيت بايثون 3 على الخادم وتشغيله</div>
                                <div class="task-creator"><a href="">کامیرون هیتفیلد</a></div>
                            ...
                            <li class="task-item">
                                ...
                                <div class="task-state">
                                    <span class="label label-orange">نشط
                                    </span>
                                </div>
                                <div class="task-time">منذ 2 ساعات</div>
                                <div class="task-body">إرسال ثائق API جديدة مع اختبار ونشر المواصفات</div>
                                <div class="task-creator"><a href="">بهرنج نیتسه</a></div>
                                <div class="task-assignedto">الملقاة على عاتقكم</div>
                            </li>
                            <li class="task-item">
                                <div class="task-check">
                                    <label>
                                ...
                                <div class="task-state">
                                    <span class="label label-palegreen">وافق
                                    </span>
                                </div>
                                <div class="task-time">أمس </div>
                                <div class="task-body">رمز إعادة بيع ديون وإعادة كتابة رموز سخيفة واختباره</div>
                                <div class="task-creator"><a href="">دیفید فینشر</a></div>
                                <div class="task-assignedto">تعيين كيم ل</div>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col=lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="databox databox-lg databox-inverted radius-bordered databox-shadowed databox-graded databox-vertical">
                        ...
                        <div class="databox-bottom no-padding">
                            <div class="databox-row">
                                <div class="databox-cell cell-6 text-align-left">
                                    <span class="databox-text">المستخدمين </span>
                                    <span class="databox-number">76,109</span>
                                </div>
                                <div class="databox-cell cell-6 text-align-right">
                                    <span class="databox-text">جديدة</span>
                ...
                <div class="col=lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="databox databox-lg databox-inverted radius-bordered databox-shadowed databox-graded databox-vertical">
                        ...
                        <div class="databox-bottom no-padding">
                            <div class="databox-row">
                                <div class="databox-cell cell-6 text-align-left">
                                    <span class="databox-text">الزيارات</span>
                ...
                <div class="col-lg-12">
                    <div class="widget">
                        <div class="widget-header bordered-bottom bordered-themesecondary">
                            ...
                            <span class="widget-caption themesecondary">مجلس تذكرة</span>
                        </div>
                        <!--Widget Header-->
                        <div class="widget-body no-padding">
                                    ...
                                    <li class="ticket-item">
                                        <div class="row">
                                            <div class="ticket-user col-lg-6 col-sm-12">
                                                ...
                                                <span class="user-name">دیویا فیلیبس</span>
                                                <span class="user-at">فی</span>
                                    ...
                                    <li class="ticket-item">
                                        <div class="row">
                                            <div class="ticket-user col-lg-6 col-sm-12">
                                                ...
                                                <span class="user-at">فی</span>
                                                <span class="user-company">جوجل</span>
                                            </div>
                                            <div class="ticket-time  col-lg-4 col-sm-6 col-xs-12">
                                                <div class="divider hidden-md hidden-sm hidden-xs"></div>
                                                <i class="fa fa-clock-o"></i>
                                                <span class="time">منذ 18 ساعات</span>
                                            </div>
                                            <div class="ticket-type  col-lg-2 col-sm-6 col-xs-12">
                                                <span class="divider hidden-xs"></span>
                                                <span class="type">قضية</span>
                                    ...
                                    <li class="ticket-item">
                                        <div class="row">
                                            ...
                                            <div class="ticket-time  col-lg-4 col-sm-6 col-xs-12">
                                                <div class="divider hidden-md hidden-sm hidden-xs"></div>
                                                <i class="fa fa-clock-o"></i>
                                                <span class="time">2 أيام منذ</span>
                                            </div>
                                            <div class="ticket-type  col-lg-2 col-sm-6 col-xs-12">
                                                <span class="divider hidden-xs"></span>
                                                <span class="type">دفع</span>
                                    ...
                                    <li class="ticket-item">
                                        <div class="row">
                                            <div class="ticket-user col-lg-6 col-sm-12">
                                                ...
                                                <span class="user-name">اریک کلابتون</span>
                                                <span class="user-at">فی</span>
                ...
                <div class="databox-top">
                    <div class="databox-row row-12">
                        <div class="databox-cell cell-3 text-center">
                            ...
                            <div class="databox-text storm-cloud">على الانترنت</div>
                        </div>
                        <div class="databox-cell cell-9 text-align-center">
                            <div class="databox-row row-6 text-left">
                                ...
                                <span class="databox-inlinetext uppercase darkgray margin-left-5">جديد</span>
                                <span class="badge badge-yellow badge-empty margin-left-5"></span>
                                <span class="databox-inlinetext uppercase darkgray margin-left-5">عودة</span>
                            </div>
                    ...
                    <div class="databox-row row-12">
                        ...
                        <div class="databox-cell cell-5 text-center no-padding-left padding-bottom-30">
                            <div class="databox-row row-2 bordered-bottom bordered-ivory padding-10">
                                ...
                                <span class="databox-text sonic-silver pull-right no-margin uppercase">في المئة</span>
                            </div>
                            <div class="databox-row row-2 bordered-bottom bordered-ivory padding-10">
                                <span class="badge badge-blue badge-empty pull-left margin-5"></span>
                                <span class="databox-text darkgray pull-left no-margin hidden-xs">تنغذی</span>
                            ...
                            <div class="databox-row row-2 bordered-bottom bordered-ivory padding-10">
                                ...
                                <span class="databox-text darkgray pull-left no-margin hidden-xs">مباشر</span>
                            ...
                            <div class="databox-row row-2 padding-10">
                                ...
                                <span class="databox-text darkgray pull-left no-margin hidden-xs">عضوي</span>
            ...
            <div class="databox databox-xxlg databox-vertical databox-inverted">
                <div class="databox-top bg-whitesmoke no-padding">
                    <div class="databox-row row-2 bg-orange no-padding">
                        ...
                        <div class="databox-cell cell-8 no-padding padding-top-5 text-align-left">
                            <span class="databox-number white">المشاهدات</span>
                        </div>
                        <div class="databox-cell cell-3 text-align-right padding-10">
                            <span class="databox-text white">13 ديسمبر</span>
                        </div>
                    </div>
                ...
                <div class="databox-bottom bg-sky no-padding">
                    <div class="databox-cell cell-2 text-align-center no-padding padding-top-5">
                        <span class="databox-header white">السبت</span>
                    </div>
                    <div class="databox-cell cell-2 text-align-center no-padding padding-top-5">
                        <span class="databox-header white">الجمعة</span>
                    </div>
                    <div class="databox-cell cell-2 text-align-center no-padding padding-top-5">
                        <span class="databox-header white">الخميس</span>
                    </div>
                    <div class="databox-cell cell-2 text-align-center no-padding padding-top-5">
                        <span class="databox-header white">الأربعاء</span>
                    </div>
                    <div class="databox-cell cell-2 text-align-center no-padding padding-top-5">
                        <span class="databox-header white">الثلاثاء</span>
                    </div>
                    <div class="databox-cell cell-2 text-align-center no-padding padding-top-5">
                        <span class="databox-header white">الإثنين</span>
                    </div>
